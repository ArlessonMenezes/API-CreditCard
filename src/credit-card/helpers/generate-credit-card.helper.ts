...
const brandBins = (brand: BrandsEnum): string => ({
  [BrandsEnum.VISA]: '492961',
  [BrandsEnum.MASTERCARD]: '53799',
  [BrandsEnum.AMEX]: '37529',
}[brand]);
...
const generateCreditCard = (brand: BrandsEnum) => {
